...
This repository contains the reference implementation and reproducible artifacts for the paper **"Evidence-Based Accountability for Smart City Data Streaming in Public Authorities: A Socio-Technical Framework Supporting GDPR Obligations"**.
